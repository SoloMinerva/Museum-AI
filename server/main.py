...
# 挂载文物图片目录
museum_images_dir = Path("data/museum_images")
museum_images_dir.mkdir(parents=True, exist_ok=True)
app.mount("/static/museum_images", StaticFiles(directory=museum_images_dir), name="museum_images")
