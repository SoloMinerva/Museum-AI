    ...
    <div class="sidebar-content">
      ...
      <div class="conversation-list-top">
        ...
        <div class="museum-selector">
          <MapPin size="14" class="museum-icon" />
          <select
            :value="agentStore.selectedMuseum"
            @change="agentStore.selectMuseum($event.target.value)"
            class="museum-select"
          >
            <option value="">全部博物馆</option>
            <option value="湖北省博物馆">湖北省博物馆</option>
            <option value="中国国家博物馆">中国国家博物馆</option>
          </select>
        </div>
      </div>
...
import { PanelLeftClose, MessageSquarePlus, ChevronDown, MapPin } from 'lucide-vue-next';
